...
# define search space
space_rf = dict()
space_rf['n_estimators'] = [100, 200, 300]
space_rf['max_depth'] = [None, 10, 15, 20, 25, 30]
space_rf['min_samples_split'] = [2, 4, 6, 8, 10]
space_rf['min_sample_leaf'] = [1, 2, 3, 4, 5, 6]
space_rf['max_features'] = ["sqrt", "log2"]
space_rf['bootstrap'] = [True, False]
search = GridSearchCV(rf, space_rf, scoring='accuracy', n_jobs=-1, cv=cv)
