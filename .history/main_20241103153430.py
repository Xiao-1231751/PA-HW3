...
features = df.drop(columns=['Status']) # Get the features without Status
target = df['Status'] # Get the Status 
...
print(f"The Feature ranking we got is {information_gain_features}")
