...
knn_prediction = knn_model.prediction()

accuracy = accuracy_score(knn_prediction, labels_test)
# recall = recall_score(y_test, auto_weighted_prediction, average='weighted')
# precision = precision_score(y_test, auto_weighted_prediction, average='weighted')
